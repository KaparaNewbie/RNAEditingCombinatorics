...
fig.update_layout(showlegend=False, width=300, height=350)
fig.update_yaxes(
    title="% noise",
    # tickmode='linear',
    # tick0=0,
...
# %%
len(recoding_changes)

# %%
len(recoding_color_sequence)

# %%
px.colors.qualitative.swatches()

# %%
len(px.colors.qualitative.Pastel)
