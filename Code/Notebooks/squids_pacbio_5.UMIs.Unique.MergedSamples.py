...
expression_files = [
    "/private7/projects/Combinatorics/D.pealeii/MpileupAndTranscripts/UMILongReads.UniqueReadsByUMISubSeq.MergedSampless/ADAR1.DistinctUniqueProteins.ExpressionLevels.csv",
