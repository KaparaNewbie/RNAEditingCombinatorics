...
distinct_unique_proteins_files = [
    "/private7/projects/Combinatorics/D.pealeii/MpileupAndTranscripts/UMILongReads.MergedSamples/ADAR1.Merged.DistinctUniqueProteins.26.03.2025-04:39:41.csv",
    "/private7/projects/Combinatorics/D.pealeii/MpileupAndTranscripts/UMILongReads.MergedSamples/IQEC.Merged.DistinctUniqueProteins.26.03.2025-00:27:18.csv",
]
...
for r_i, cond in enumerate(row_vals, start=1):
    ...
    # color = (color_discrete_map.get(cond) if _use_color_map else None)
    color = color_discrete_map.get(cond)
...
fig.write_image(
    Path(out_dir, "Mean edited positions vs expression levels - PacBio2.svg"),
    width=width,
    height=height,
)
...
fig.write_image(
    Path(
        out_dir,
        "Per-site editing in abundant vs. rare isoforms - PB2.svg"
    ),
    width=width,
    height=height,
)
