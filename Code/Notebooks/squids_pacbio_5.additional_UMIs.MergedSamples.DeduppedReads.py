...
sep = "\t"
positions_files = [
    f"/private6/projects/Combinatorics/D.pealeii/MpileupAndTranscripts/AdditionalUMILongReads.DeduppedReads/{chrom}.merged.MinRQ998.positions.csv.gz"
    for chrom in chroms
]
...
# ]
reads_files = [
    f"/private6/projects/Combinatorics/D.pealeii/MpileupAndTranscripts/AdditionalUMILongReads.DeduppedReads/{chrom}.merged.MinRQ998.reads.csv.gz"
    for chrom in chroms
]
# snps_reads_files = [
...
# ]
unique_reads_files = [
    f"/private6/projects/Combinatorics/D.pealeii/MpileupAndTranscripts/AdditionalUMILongReads.DeduppedReads/{chrom}.merged.MinRQ998.unique_reads.csv.gz"
    for chrom in chroms
]
proteins_files = [
    f"/private6/projects/Combinatorics/D.pealeii/MpileupAndTranscripts/AdditionalUMILongReads.DeduppedReads/{chrom}.merged.MinRQ998.proteins.csv.gz"
    for chrom in chroms
]
unique_proteins_files = [
    f"/private6/projects/Combinatorics/D.pealeii/MpileupAndTranscripts/AdditionalUMILongReads.DeduppedReads/{chrom}.merged.MinRQ998.unique_proteins.csv.gz"
    for chrom in chroms
]
...
distinct_unique_proteins_files = [
    "/private6/projects/Combinatorics/D.pealeii/MpileupAndTranscripts/AdditionalUMILongReads.DeduppedReads/comp141693_c0_seq1.DistinctUniqueProteins.06.07.2026-15:48:37.csv",
    "/private6/projects/Combinatorics/D.pealeii/MpileupAndTranscripts/AdditionalUMILongReads.DeduppedReads/comp134400_c0_seq1_extended.DistinctUniqueProteins.06.07.2026-15:48:25.csv",
    "/private6/projects/Combinatorics/D.pealeii/MpileupAndTranscripts/AdditionalUMILongReads.DeduppedReads/comp141565_c6_seq3.DistinctUniqueProteins.06.07.2026-15:51:28.csv"
]
...
expression_files = [
    f"/private6/projects/Combinatorics/D.pealeii/MpileupAndTranscripts/AdditionalUMILongReads.DeduppedReads/{condition}.DistinctUniqueProteins.ExpressionLevels.EntropyConsidered.csv"
...
max_expression_df.to_csv(
    "/private7/projects/Combinatorics/Code/Notebooks/AssignedExpression.PacBio3.DeduppedReads.tsv",
    sep="\t",
    index=False,
)
